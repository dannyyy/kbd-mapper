...
// Iris CE: 56 keys, split ergonomic 4x6+4 per side (Kailh Choc switches, MCC/MBK spacing)
// Same key positions as Iris SE — physical layout is identical across Iris variants
...
export const irisCe: PhysicalLayout = {
  id: 'iris-ce',
  name: 'Iris CE',
